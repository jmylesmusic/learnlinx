...
async function createRoom() {
  ...
  const isLocal =
    import.meta.env.VITE_REACT_APP_ROOM_ENDPOINT &&
    import.meta.env.VITE_REACT_APP_ROOM_ENDPOINT === "local";
  ...
  */
  const headers = isLocal && {
    headers: {
      ...
      Authorization: `Bearer ${import.meta.env.VITE_REACT_APP_DAILY_API_KEY}`,
    },
  };
